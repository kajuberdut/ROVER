...
from sqlalchemy import (
    MetaData, Table, Column, String, TIMESTAMP, Boolean, ForeignKey, 
...
product_users = Table(
    'product_users', metadata,
    Column('user_sub', String, ForeignKey('users.sub', ondelete='CASCADE'), primary_key=True, nullable=False),
    Column('product_id', String, ForeignKey('products.id', ondelete='CASCADE'), primary_key=True, nullable=False),
...
api_tokens = Table(
    'api_tokens', metadata,
    Column('id', String, primary_key=True),
    Column('user_sub', String, ForeignKey('users.sub', ondelete='CASCADE'), nullable=False),
    Column('name', String, nullable=False),
